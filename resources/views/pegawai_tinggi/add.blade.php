    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <hr/>
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('pegawai_tinggi/add') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select name="subcategory_id" id="SUB3" class="form-control">
                                    <option>--Seksyen--</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="role" class="col-md-4 control-label">Peranan</label>
