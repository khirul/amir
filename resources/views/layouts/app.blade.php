        ...
        <div class="container-fluid" style="background-color:black">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse" style=" background-color: black;">
                ...
                <ul class="nav navbar-nav">
                    ...
                    {{-- @elseif(Auth::user() && Auth::user()->Roles->first()->name == 'petugas'||Auth::user() && Auth::user()->Roles->first()->name == 'pemproses'||Auth::user() && Auth::user()->Roles->first()->name == 'penyelia' ) --}}
                    @elseif(Auth::user() && Auth::user()->Roles->all() )
                    <li><a class="navbar-jurnal" href="{{ url('/journal') }}">Senarai Jurnal</a></li>
