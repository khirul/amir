    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                {{-- <div class="panel-heading">Kemaskini Profil Pegawai Penyelia 2</div> --}}
                <div class="panel-body">
                        <p class="text-right"><span class="label label-info">Daerah</span></p>
                        <h3>Kemaskini Profil Penyelia 2</h3>
                        <hr/>
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('penyelia_2_daerah/edit/'.$petugas->id) }}">
                        {{ csrf_field() }}
                        ...
                        <div hidden class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="cawangan" type="text" class="form-control" name="cawangan" value="Daerah">
                                </div>
                            </div>
