    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                {{-- <div class="panel-heading">Kemaskini Profil Penyelia 1</div> --}}
                <div class="panel-body">
                        <p class="text-right"><span class="label label-info">Kontinjen</span></p>
                        <h3>Kemaskini Profil Penyelia 1</h3>
                        <hr/>
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('penyelia_kontinjen/edit/'.$petugas->id) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('no_badan') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input readonly id="no_badan" type="text" class="form-control" name="no_badan" value="{{ old('name',$petugas->no_badan) }}">
