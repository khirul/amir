    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <p class="text-right"><span class="label label-info">Admin Kontinjen</span></p>
                <h3>Tambah Admin</h3>
                <hr/>
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('admin_kontinjen/add') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('no_badan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <small>Sila masukkan <span style="color:red"><b>No Personal</b></span></small>
                        ...
                        <div class="form-group{{ $errors->has('seksyen') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <small>Sila masukkan <span style="color:red"><b>E7</b></span> bagi pendaftaran admin kontinjen</small>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <small>Sila masukkan <span style="color:red"><b>Pegawai Turus E7</b></span> bagi pendaftaran admin kontinjen</small>
                            </div>
                        </div>
                        <div hidden class="form-group{{ $errors->has('role') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="role" type="text" class="form-control" name="role" value="admin_kontinjen">
