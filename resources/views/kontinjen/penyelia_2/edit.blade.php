        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <hr/>
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('penyelia_2_kontinjen/edit/'.$petugas->id) }}">
                        {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('jawatan') ? ' has-error' : '' }}">
                                ...
                                <div class="form-group{{ $errors->has('rank') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            <input id="eml" type="text" class="form-control" name="email" value="{{ old('email',$petugas->email) }}">
