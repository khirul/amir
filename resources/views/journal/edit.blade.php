                ...
                <div class="jumbotron">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('journal/edit/'.$journal->id) }}">
                        ...
                        <div class="form-group {{ $errors->has('tajuk_journal') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                            <input id="tajuk_journal" type="text" class="form-control" name="tajuk_journal" value="{{ old('tajuk_journal',$journal->tajuk_journal) }}">
                        ...
                        <div class="form-group {{ $errors->has('tajuk_artikel') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-10 {{ $errors->has('tajuk_artikel') ? ' has-error' : '' }}">
                                    ...
                                    <option value="Laporan Siasatan" @if($journal->
                                        tajuk_artikel=="Laporan Siasatan")selected
                                        @endif>Laporan Siasatan</option>
                                    <option value="Laporan Maklumat" @if($journal->
                                        tajuk_artikel=="Laporan Maklumat")selected
                                        @endif>Laporan Maklumat</option>
                                    <option value="Laporan Reaksi" @if($journal->
                                        tajuk_artikel=="Laporan Reaksi")selected
                            ...
                            <div class="form-group {{ $errors->has('artikel') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-10">
                                            <textarea class="form-control" name="artikel" id="artikel" cols="30" rows="5" placeholder="Your article here">{{ old('artikel',$journal->artikel) }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('tarikh_journal') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tarikh_journal" type="date" class="form-control" name="tarikh_journal" value="{{ old('tarikh_journal',$journal->tarikh_journal) }}">
                        ...
                        <div class="form-group {{ $errors->has('rujukan_fail') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="rujukan_fail" type="text" class="form-control" name="rujukan_fail" value="{{ old('rujukan_fail',$journal->rujukan_fail) }}">
