...
<div class="container">
    <div class="row">
        ...
        <a href="penyelia_2/add" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Tambah	</a>
        <hr>
            ...
            <table class="table table-condensed table-bordered table-hover table-striped dt" id="penyelia_2">
            	...
            	@foreach($penyelia_2 as $petugas)
            		<tr>
            			...
            			<td>
            			<a href="penyelia_2/edit/{{ $petugas->id }}" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
            			<a href="penyelia_2/delete/{{ $petugas->id }}" class="btn btn-danger delete btn-sm" ><i class="glyphicon glyphicon-trash"></i></a>
            			 </td>
            		</tr>
            	@endforeach
            	</tbody>
