...
<div class="container">
    <div class="row">
        ...
        <a href="penyelia/add" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Tambah	</a>
        <hr>
            ...
            <table class="table table-condensed table-bordered table-hover table-striped dt" id="penyelia">
            	...
            	@foreach($penyelia as $petugas)
            		<tr>
            			...
            			<td>
            			<a href="penyelia/edit/{{ $petugas->id }}" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
            			<a href="penyelia/delete/{{ $petugas->id }}" class="btn btn-danger delete btn-sm" ><i class="glyphicon glyphicon-trash"></i></a>
            			 </td>
            		</tr>
            	@endforeach
            	</tbody>
